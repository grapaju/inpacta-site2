...
export async function GET(request) {
  try {
    ...
    const defaultSettings = {
      google_analytics_id: '',
      google_search_console_id: '',
      meta_title: 'InPACTA — Inovação pública em Maringá-PR',
      meta_description: 'O InPACTA acelera a modernização administrativa e tecnológica do setor público em Maringá-PR.',
      meta_keywords: 'inpacta, inovação pública, maringá, governança, dados, tecnologia',
      og_title: 'InPACTA — Inovação pública em Maringá-PR',
      og_description: 'Fortalecendo a governança pública com inovação, tecnologia e inteligência de dados em Maringá-PR.',
      og_image: '/logo.png',
