        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2 sm:py-2.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 sm:gap-6 flex-1 min-w-0">
              <a 
                href="mailto:contato@inpacta.mg.gov.br" 
              ...
              >
                ...
                <span className="hidden md:inline truncate">contato@inpacta.mg.gov.br</span>
                <span className="md:hidden">Contato</span>
              </a>
              <a 
                href="tel:+554439011234" 
              ...
              >
                ...
                <span className="hidden sm:inline">(44) 3901-1234</span>
