export const projects = [
  ...
  },
  {
    ...
    title: "Observatório Municipal de Segurança Pública",
    description: "Implantação de núcleo permanente de inteligência com dashboards, portal público e análises territorializadas.",
    category: "dados-inteligencia",
  },
  {
    slug: "planejamento-estrategico-gm",
    title: "Planejamento Estratégico da Guarda Municipal",
    description: "Reestruturação operacional com protocolos de uso responsável da força e integração ao SUSP.",
    category: "governanca",
  },
  {
    slug: "revisao-processos-protocolos",
    title: "Revisão de Processos e Protocolos Operacionais",
    description: "Padronização de manuais, fluxos internos e alinhamento à LGPD para guardas municipais.",
    category: "governanca",
  },
  {
    slug: "portal-transparencia-dados",
    title: "Portal de Transparência e Dados Públicos",
    description: "Plataforma pública com indicadores, relatórios e visualizações para controle social.",
    category: "dados-inteligencia",
  },
  {
    slug: "pmo-seguranca-publica",
    title: "PMO de Segurança Pública Municipal",
    description: "Escritório de projetos para coordenação de implementação de planos de segurança com governança integrada.",
    category: "pmo",
  },
];
